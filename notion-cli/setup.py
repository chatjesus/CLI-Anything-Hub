...
setup(
    ...
    version="1.0.0",
    description="Notion REST API CLI - part of CLI Anything Hub. AI-agent-friendly, JSON output, works with Claude/ChatGPT/Copilot",
    ...
    project_urls={
        "Documentation": "https://www.agentputer.com/cli-anything/notion/",

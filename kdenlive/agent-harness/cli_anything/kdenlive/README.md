...
### How do I install cli-anything-kdenlive?
...
Yes. All commands support the `--json` flag for structured output that LLMs can parse directly. This tool is listed on the [CLI-Anything Hub](https://www.agentputer.com/cli-anything/kdenlive/).

### How do I check if the software is available?

```bash
cli-anything-kdenlive detect --json
```

...
### How do I install cli-anything-inkscape?
...
Yes. All commands support the `--json` flag for structured output that LLMs can parse directly. This tool is listed on the [CLI-Anything Hub](https://www.agentputer.com/cli-anything/inkscape/).

### How do I check if the software is available?

```bash
cli-anything-inkscape detect --json
```

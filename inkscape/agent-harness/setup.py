...
setup(
    ...
    author_email="",
    description="CLI harness for Inkscape - SVG vector graphics with export via inkscape --export-filename. Requires: inkscape (apt install inkscape). AI-agent-friendly, JSON output, works with Claude/ChatGPT/Copilot",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/HKUDS/CLI-Anything",
    project_urls={
        "Documentation": "https://www.agentputer.com/cli-anything/inkscape/",
